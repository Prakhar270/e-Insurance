...
<html lang="en">
  ...
  <body>
    ...
    >
      ...
      <a href="reg.php" class="btn btn-primary px-3 d-none d-lg-block">Insure now</a>
    </nav>
      ...
      <div class="container py-5">
        <div class="row g-5">
          ...
          <div class="col-lg-3 col-md-6">
            ...
            <p><i class="fa fa-phone-alt me-3"></i>+913456789098</p>
            <p><i class="fa fa-envelope me-3"></i>prakhar@example.com</p>
          </div>
          <div class="col-lg-3 col-md-6">
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
              &copy; <a href="#">e-INSURANCE</a>, All Right Reserved.
            </div>
            <div class="col-md-6 text-center text-md-end">
              <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
              Designed By <a href="https://www.linkedin.com/in/prakhar-gupta-2001/">Prakhar Gupta</a>
              <br />Distributed By:
